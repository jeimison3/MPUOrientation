...
void setup() {
  ...
  IMU.setMagCalX(6.337158, 1.004768);
  IMU.setMagCalY(-12.652475, 1.393557);
  IMU.setMagCalZ(-56.515892, 0.776906);
...
void loop() {
  ...
  IMUOrientation ori = getOrientation(CNTX, ALGO_MADGWICK_V1, SENS, dt);
